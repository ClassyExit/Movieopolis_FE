  ...
  <div class="flex items-center">
    <button class="btn btn-sm btn-outline btn-primary" @click="openModal">
      <div class="flex flex-row items-center space-x-2">
        ...
        <span v-if="show.reviews.results.length">{{
...
const showReviewModal = ref(null);
const openModal = () => showReviewModal.value?.showModal();
const closeModal = () => showReviewModal.value?.close();
</script>
