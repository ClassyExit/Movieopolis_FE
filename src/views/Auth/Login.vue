<template>
  ...
  >
    <div
      class="w-full text-content2 p-4 space-y-4 rounded md:bg-backgroundSecondary md:shadow-xl"
    >
      ...
      <div v-if="formValueErrors.failedLogin" class="alert alert-error">
        ...
        <div class="flex flex-col text-left">
          <span class="text-content2"
            >Sorry, we're unable to authenticate your account. If you've forgot
            your password -
            <router-link :to="{ name: 'Reset' }" class="text-link"
